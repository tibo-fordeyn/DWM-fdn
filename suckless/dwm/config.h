...
static char *fonts[]          = { "monospace:ize=16", "NotoColorEmoji:pixelsize=10:antialias=true:autohint=true"  };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_s,		spawn,		SHCMD("scrot '/home/dyntif/dl/screenshots/%d-%m-%T-screenshot.png'") },
