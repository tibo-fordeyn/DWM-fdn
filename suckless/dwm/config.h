...
static const int vertpad            = 34;       /* vertical padding of bar */
static const int sidepad            = 125;       /* horizontal padding of bar */
...
/* Hoofdletter m zet bepaalde processen uit, ik zou het niet aanraken
	...
	{ MODKEY,			XK_comma,	spawn,		{.v = (const char*[]){ TERMINAL, "-e", "newsboat", NULL } }},
	...
	{ 0, XF86XK_AudioRaiseVolume, 	spawn, 		SHCMD("~/.local/bin/volume-up.sh") },
    	{ 0, XF86XK_AudioLowerVolume, 	spawn, 		SHCMD("~/.local/bin/volume-down.sh") },
